                ...
                <h2 class="home-section-title mb-4">{{__("Activities")}}
                    <a href="{{route('activities')}}">{{__("View All")}}
                        <svg width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.5 11L6.5 6L1.5 1" stroke="#1A438F" stroke-width="1.5" stroke-linecap="round"
                        ...
                        <div class="col-md-4 col-12 item">
                            <div class="position-relative">
                                <a href="{{route('activity.show', $activity->slug)}}">
                                    <img src="{{$activity->thumb_image}}" alt="{{$activity->currentMl->name}}"
                            ...
                            <div class="item p-4">
                                ...
                                <div class="language">
                                    @foreach(\Mcamara\LaravelLocalization\Facades\LaravelLocalization::getSupportedLocales() as $key => $value)
                                        <span class="@if($loop->first) active @endif material_language_item"
                                              @if($loop->index > 2) style="display: none" @endif
                                              data-material_id="{{$material->id}}"
                                              data-lang="{{$key}}">{{$value['displayName']}}</span>
                                        @if($loop->index == 2)
                                    ...
                                    <div class="shape-block-inner">
                                        ...
                                        <a href="{{$partner->website}}" target="_blank">
                                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M9.00876 0.276367C4.49953 0.276367 0.844604 3.93238 0.844604 8.44095C0.844604 12.9497 4.49953 16.6047 9.00876 16.6047C13.518 16.6047 17.1729 12.9497 17.1729 8.44095C17.1729 3.93238 13.518 0.276367 9.00876 0.276367ZM3.10814 9.52232H4.36041C4.56994 11.1 5.23808 12.5814 6.28193 13.7827C4.64888 12.9458 3.44842 11.3831 3.10814 9.52232ZM4.36041 7.3585H3.10814C3.44864 5.49794 4.6491 3.93521 6.28215 3.09833C5.23828 4.2996 4.57006 5.78092 4.36041 7.3585ZM7.92673 12.3722C7.22109 11.5629 6.74633 10.5786 6.55233 9.52254H7.92673V12.3722ZM7.92673 7.3585H6.55233C6.74643 6.30256 7.22117 5.31834 7.92673 4.5091V7.3585ZM14.9092 7.3585H13.6571C13.4476 5.78103 12.7795 4.2998 11.7358 3.09855C13.3684 3.93565 14.5689 5.49838 14.9092 7.3585ZM10.0908 12.3717V9.52232H11.4652C11.2709 10.5782 10.7962 11.5624 10.0908 12.3717ZM10.0908 7.3585V4.50888C10.7964 5.31814 11.2712 6.30246 11.4652 7.3585H10.0908ZM11.7351 13.7829C12.7792 12.5816 13.4475 11.1001 13.6571 9.52232H14.9094C14.5691 11.3833 13.3684 12.946 11.7351 13.7829Z"
                                                    fill="white"/>
                                            </svg>
                                        </a>
